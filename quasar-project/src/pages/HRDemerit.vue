      ...
      <div class="my-card">
        <q-card-section class="bg-primary text-white" style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center;">
              ...
              >
                <q-list>
                  <q-item clickable v-close-popup @click="onItemClick('employee')">
                    <q-item-section>
                      <q-item-label>EMPLOYEE DEMERIT</q-item-label>
                    </q-item-section>
                  </q-item>

                  <q-item clickable v-close-popup @click="onItemClick('department')">
                    <q-item-section>
            ...
            <div class="q-gutter-md row" style="display: flex; align-items: center;">
              <q-input dark dense standout v-model="searchQuery" input-class="text-right" class="q-ml-md" style="background-color: #024089; border: 0.2em solid #f3f4f7; border-radius: 0.5em;">
  ...
  data(){
    return{
      ...
      disEmploColumns: [
          ...
          { name: 'employeeCode', label: 'EMPLOYEE NUMBER', align: 'left', field: 'employeeCode' },
          { name: 'PenaltiesCode', label: 'PENALTIES', align: 'left', field: 'PenaltiesName' },
      ],
      disAllDepartment: [],
      disColumnsDepartment: [
          { name: 'Department_Description', label: 'DEPARTMENT NAME', align: 'left', field: 'Department_Description' },
          { name: 'demerits', label: 'DEMERITS', align: 'left', field: 'totalDemerits' },
      ],
      showTable: false,
      selectedOption: ''
    }
