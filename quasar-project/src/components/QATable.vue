                ...
                <q-list>
                  <q-item v-for="(ird, index) in IRQADetailss" :key="index">
                    <q-item-section class="custom-item-section">
                      ...
                      <q-item-section class="QADes" >
                        <q-item-section class="QAlist">
                            <div class="QATextlist">ROOT CAUSE ANALYSIS (RCA) ACTION ITEMS </div>
                        </q-item-section>
        ...
        <q-dialog v-model="setQATraDialogs">
          <q-card>
            ...
            <q-card-actions align="right">
              <q-btn push label="NO" color="secondary" @click="setQATraDialogs = false" />
              <q-btn push label="YES" color="accent" class="text-black" @click="saveQATra" />
            </q-card-actions>
          </q-card>
        </q-dialog>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
        <q-dialog v-model="setQATrans" persistent>
          <q-card class="QAIC">
            ...
            <q-separator style="background-color: #d5d7da; height: 2px; margin: 2px 0;"></q-separator>
            <q-card-actions align="right">
              <q-btn push label="CANCEL" color="secondary" @click="cancelTrans" />
              <q-btn push label="SAVE" color="accent" class="text-black" @click="transfer" />
            </q-card-actions>
          </q-card>
        </q-dialog>

<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
        <q-dialog v-model="transfering" persistent content-class="non-transparent-dialog">
  ...
  <template v-slot:body-cell-lostrec="props">
      <q-td>
        <span v-if="props.row.lostRec === 1" class="text-positive text-bold text-center">YES</span>
        <span v-if="props.row.lostRec === 2" class="text-negative text-bold text-center">NO</span>
      </q-td>
  </template>

  <template v-slot:body-cell-involvedDept="props">
    <q-td>
      <span class="text-dark text-bold text-center">{{ props.row.Department_Involved }}</span>
    </q-td>
  </template>
          ...
          <q-card class="QADeptIn">
            ...
            <q-card-section>
              ...
              <q-item-section class="QADLay q-ml-auto">
                <div class="QADTestlist">OTHER DEPARTMENT/S INVOLVED
                  <q-btn
                    class="q-ml-auto"
                    flat
                    round
              ...
              <div>
                <div
                  ...
                  :key="index"
                  style="margin-top: 8px; display: flex; align-items: center; margin-left: 15px;"
                >
                  <q-select
                  use-input
                  square
              ...
              <q-card-actions align="right" class="footer-actions">
                <q-btn push label="Cancel" color="secondary" @click="onRCACancel" />
                <q-btn push label="Save" color="accent" class="text-black" @click="submitRCAEmail" />
              </q-card-actions>
          </q-card>
        </q-dialog>

                <q-dialog v-model="rdPWait" persistent content-class="non-transparent-dialog">
                  <q-card class="centered-card">
                    <q-card-section>
                      <div class="spinner-container">
                        <q-spinner-facebook size="100px"></q-spinner-facebook>
                        <div class="please-wait">Notifiying the Department Heads. Please wait...</div>
                      </div>
                    </q-card-section>
                  </q-card>
                </q-dialog>
...
<!-- ///////////////////////////////////////CONFIRM RCA SUBMISSION////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
      ...
      <q-dialog v-model="setRCASubDialogs">
        <q-card>
          ...
          <q-separator style="background-color: #d5d7da; height: 2px;"></q-separator>
          <q-card-actions align="right">
            <q-btn push label="NO" color="secondary" @click="setRCASubDialogs = false" />
            <q-btn push label="YES" color="accent" class="text-black" @click="saveIRCA" />
          </q-card-actions>
        </q-card>
      </q-dialog>
...
<!-- ///////////////////////////////////////RCA REMARKS////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
      ...
      <q-card-section>
            ...
            <q-card-actions align="right" class="footer-actions">
              <q-btn push label="DISAPPROVED" color="secondary" @click="submitRCADisapprovedEmail(selectedIrNo)" />
              <q-btn push label="APPROVED" color="accent" class="text-black" @click="ConclusionSubmit(selectedIrNo)" />
            </q-card-actions>
        </q-card>
      </q-dialog>
        ...
        <q-card class="QCRCApproved">
          <q-card-section class="QAPApproved">
            ...
            <q-item-section class="QAPLay">
              <q-input outlined v-model="IrNo" label="IRNo." style="display: none;" />
              <div class="QAPTestlist"> ADD ACTIONS
                <q-btn
                  class="q-ml-auto"
                  flat
                  round
            ...
            <q-item-section>
              <div
                ...
                :key="index"
                style="margin-top: 8px; display: flex; align-items: center; margin-left: 10px;"
              >
                <q-input v-model="party.ActionItem" label="ACTION NOTE" outlined autogrow style="width: 70%;"/>
                <q-input
                ...
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer" @click="showActionDatePicker = true" />
                </template>
            ...
            <q-card-actions align="right" class="acfooter-actions">
              <q-btn push label="Cancel" color="secondary" @click="onCancelApprovedRCA" />
              <q-btn push label="Save" color="accent" class="text-black" @click="saveRCAApprovedEmail(selectedIrNo)" />
            </q-card-actions>
        </q-card>
      </q-dialog>

                <q-dialog v-model="acWait" persistent content-class="non-transparent-dialog">
                  <q-card class="centered-card">
                    <q-card-section>
                      <div class="spinner-container">
                        <q-spinner-facebook size="100px"></q-spinner-facebook>
...
<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
  ...
  <template v-slot:body-cell-actionitems="props">
    <q-td>
      <q-btn
      push
      :disable="props.row.QAStatus === false || props.row.CombinedActionItems && !props.row.CombinedActionItems.split(', ').includes('1')"
      v-if="props.row.RCA === '3' && props.row.CombinedActionItems && props.row.CombinedActionItems.split(', ').includes('1')"
      ...
      <q-btn
        :disable="props.row.CombinedActionItems && !props.row.CombinedActionItems.split(', ').includes('1')"
        v-if="props.row.CombinedActionItems && !props.row.CombinedActionItems.split(', ').includes('1')"
...
<!-- //////////////////////////////////////ACTION ITEMS////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
      ...
      <q-dialog full-width full-height v-model="setActionItemDialogs" persistent>
        <q-card class="QAACT">
          <q-card-section class="QAACTHead">
              <div class="row items-center justify-between">
                <div class="QAACText">ACTION DETAILS</div>
                <div>
                  <q-btn push label="CLOSE" color="info" @click="onCloseActionItems()" />
                  <q-btn
                    push
              ...
              <q-card-section>
                <q-list bordered>
                  <q-item v-for="(actionitems, index) in actionitemDetails" :key="index">
                    <q-item-section class="QAACTABLE" v-if="actionitems">
                      <div class="QAACTabtext">
                        <div style="display: flex; justify-content: space-between;">
                          <div><b>TIMELINE FROM:</b> {{ FormatTimelineDateFrom(actionitems.TimelineFromDate) }}  </div>
                          <div><b>TIMELINE TO:</b> {{ FormatTimelineDateTo(actionitems.TimelineToDate) }}  </div>
                        </div>
                        <div style="background-color: #FFC619; height: 2px; margin: 5px 0;"></div>
                        <div><b>CORRECTIVE/ PREVENTIVE ACTION:</b><br> {{ actionitems.ActionItem }}</div>
                      </div>
                    </q-item-section>

                    <q-item-section style="border: 1px solid #ccc;" side>
                      <span class="text-dark text-bold text-center" style="margin-bottom: 10px; margin-right: 20px;">VERIFICATION</span>
                      <q-btn
                        push
                      ...
                      <q-dialog v-model="setActionStatusDialogs" persistent>
                        <q-card>
                          ...
                          <q-card-section>
                            ...
                            <div>ARE YOU SURE THAT THE CORRECTIVE/ PREVENTIVE WAS IMPLEMENTED?</div>
                          </q-card-section>

                          <q-separator style="background-color: #d5d7da; height: 2px;"></q-separator>
                          <q-card-actions align="right" >
                            <q-btn push label="NO" color="secondary" @click="setActionStatusDialogs = false" />
                            <q-btn push label="YES" color="accent" class="text-black" @click="saveActionStatus(actionitems.IRNo)" />
                          </q-card-actions>
                        </q-card>
                      </q-dialog>
                  ...
                  <q-dialog v-model="setQADialogs">
                          <q-card>
                            ...
                            <q-separator style="background-color: #d5d7da; height: 2px;"></q-separator>
                            <q-card-actions align="right">
                              <q-btn push label="CLOSE" color="secondary" @click="setQADialogs = false" />
                              <q-btn push label="YES" color="accent" class="text-black" @click="saveIRQAStatus(selectedIrNo)" />
                            </q-card-actions>
                          </q-card>
                  </q-dialog>
    ...
    <td>
      ...
      <q-dialog full-width full-height v-model="setRemarksDialogs" persistent>
        <q-card class="QAACT">
          <q-card-section class="QAACTHead">
                        <div class="row items-center justify-between">
                          <div class="QAACText">REMARKS FOR PENDING ACTION ITEMS</div>
                            <div>
                              <q-btn @click="addPendingRemarks(selectedIrNo)" color="secondary " icon="post_add" label="Add Remarks" style="background-color: #024089; border: 0.2em solid #f3f4f7; border-radius: 0.5em;"/>
                              <q-btn style=" margin-left: 25px;" round push icon="close" class="bg-accent text-black" @click="cancelPendingRemarks()" v-close-popup/>
                            </div>
                        </div>
          </q-card-section>
          ...
          <q-dialog v-model="PendingRemarksDia" persistent>
              <q-card class="QCRCA">
                ...
                <q-card-section>
                      ...
                      <q-card-actions align="right" class="footer-actions">
                        <q-btn push label="CANCEL" color="secondary" @click="onClosePendingRem" />
                        <q-btn push label="SAVE" color="accent" class="text-black" @click="savePendingRemarks(selectedIrNo)" />
                      </q-card-actions>
              </q-card>
          </q-dialog>
          ...
          <q-card-section>
            <q-list bordered>
              <q-item v-for="(pendingDet, index) in pendingRemarksDetails" :key="index">
                <q-item-section class="QAACTABLE" v-if="pendingDet">
                  <div class="QAACTabtext">
                    <div>
                      <div><b>DATE:</b> {{ FormatTimelineDateFrom(pendingDet.DateTimeCreated) }} </div>
                      <div style="background-color: #FFC619; height: 2px; margin: 5px 0;"></div>
                      <div><b>REMARKS NOTE:</b><br> {{ pendingDet.PendingRemarks }}</div>
                    </div>
                  </div>
                </q-item-section>
              </q-item>
...
data() {
  return {
    ...
    actionparties: [
        { ActionItem: '', TimelineFromDate: new Date().toISOString().substr(0, 10), TimelineToDate: '' }
    ],
    ActionItem: "",
    acWait: false,
...
computed: {
...mapGetters({ getQACon: 'ApplyStore/getQACon', departments: 'ApplyStore/departments', getActionItem: 'ApplyStore/getActionItem', getRemarks: 'ApplyStore/getRemarks'}),
...
///////////////////////////////////////QA INCHARGE//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  qaTransfer(IRNo, SubjectCode) {
    ...
    console.log('DATA', IRNo, SubjectCode)
  },
...
///////////////////////////////////////REQUIRED//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  async saveRCAEmail(){
    try {
      ...
      this.onRCACancel();
      const response = await this.$store.dispatch("ApplyStore/addEmail", qaEmail);
      console.log("DATA INSERTED SUCCESSFULLY");
    } catch (error) {
      console.error("Error inserting data:", error);
    }
  ...
  if (this.parties.length < 4) {
      ...
      console.log('Cannot add more than 4 parties');
    }
  },
...
async saveIRCA() {
  try {
    ...
    const response = await this.$store.dispatch("ApplyStore/putRCASub", payload);
    setTimeout(() => {
      this.getInc();
    }, 2000);
    this.$q.notify({
...
async submitRCADisapprovedEmail(IRNo) {
  try {
    ...
    this.acWait = true;
    const response = await this.$store.dispatch("ApplyStore/addRCADispproved", DispprovedRca);
    console.log("DATA INSERTED SUCCESSFULLY");
...
addActionItem() {
  this.actionparties.push({ ActionItem: '', TimelineFromDate: new Date().toISOString().substr(0, 10), TimelineToDate: '' });
},
...
validateApprovedAction() {
  return this.actionparties.every(party => party.ActionItem && party.TimelineToDate);
},
...
async submitRCAApprovedEmail(IRNo) {
  try {
    const ApprovedRca = {
      ...
      TimelineFromDate: this.actionparties.map(party => party.TimelineFromDate),
      TimelineToDate: this.actionparties.map(party => party.TimelineToDate)
    };
    this.onCancelApprovedRCA();
    console.log(ApprovedRca)
...
async saveIRQAStatus(IRNo){
  try {
        ...
        const response = await this.$store.dispatch("ApplyStore/putqaIR", payload);
        this.setActionItemDialogs = false;
        this.itemWait = true;
        setTimeout(() => {
          this.getInc();
