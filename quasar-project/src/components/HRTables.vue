<template>
    ...
    <template v-slot:body-cell-viewIR= "props">
        <q-td>
          ...
          <q-dialog full-width full-height v-model="IRDialog" persistent>
            <q-card class="HRVDia">
                    <q-card-section class="HRVHead">
                        <div class="HRVText">INCIDENT REPORT DETAILS</div>
                        <div class="HRVBC">
                  ...
                  <q-list>
                    <q-item v-for="(ird, index) in IRQADetailss" :key="index">
                      <q-item-section class="custom-item-section">
                        <q-item-section class="HRVList">
                            <div class="HRVGT">INCIDENT INFORMATION</div>
                        </q-item-section>

                        <q-item-section class="HRDes">
                        ...
                        <q-item-section class="HRDes">
                          <q-item-section class="HRVList">
                              <div class="HRVGT">ROOT CAUSE ANALYSIS (RCA) ACTION ITEMS</div>
                          </q-item-section>
                        ...
                        <q-item-section class="HRDes">
                          <q-item-section class="HRVList">
                              <div class="HRVGT">HUMAN RESOURCES(HR) NOTES </div>
                          </q-item-section >
                            <q-item-section v-if="ird.newHRNote">
                                <div><b>NOTE:</b></div>
    ...
    <template v-slot:body-cell-financialLia="props">
      <q-td>
        ...
        <q-btn push style="width: 125px;" label="COLLECT" v-if="props.row.FinancialLiability === 'COLLECT'" :disable="props.row.FinancialLiability === 'COLLECT'"  class="bg-negative text-white text-bold text-center shadow-5" />
        <q-btn push style="width: 125px;" label="WAVE" v-if="props.row.FinancialLiability === 'WAVE'" :disable="props.row.FinancialLiability === 'WAVE'" class="bg-positive text-white text-bold text-center shadow-5" />
        <q-btn
          push
          :ripple="{ center: true }"
          label="NOT APPLICABLE"
          style="width: 125px;"
          :disable="props.row.FinancialLiability === 'NOT APPLICABLE' || props.row.lostRec === 2"
          v-if="props.row.FinancialLiability === 'NOT APPLICABLE' || props.row.lostRec === 2"
...
<!-- <div old process>
        ...
        <q-dialog v-model="setFinLiaDialogs">
            <q-card>
              ...
              <q-card-actions align="center">
                <q-btn style="width: 115px;" label="WAVE" class="bg-accent text-black text-bold text-center shadow-5" @click="saveResponse('WAVE')" />
                <q-btn style="width: 115px;" label="COLLECT" class="bg-accent text-black text-bold text-center shadow-5" @click="saveResponse('COLLECT')" />
              </q-card-actions>
            </q-card>
        </q-dialog>
    ...
    <template v-slot:body-cell-hrnotes="props">
      <td>
        ...
        v-if="props.row.lostRec === 2 || props.row.FinancialLiability === 'NOT APPLICABLE'"
        ...
        push
        icon="note_add"
        :disable="props.row.HRStatus === false || props.row.newHRNote !== null"
        v-if="props.row.FinancialLiability === 'COLLECT' || props.row.FinancialLiability === 'WAVE'"
        ...
        <q-dialog v-model="setHRNDialogs" persistent>
            <q-card class="HRNT">
                  ...
                  <q-separator style="background-color: #d5d7da; height: 2px; margin: 5px 0;"></q-separator>
                  <q-card-actions align="right">
                    <q-btn push label="CANCEL" color="secondary" @click="cancelConclusion" />
                    <q-btn push label="SAVE" color="accent" class="text-black" @click="ConSubmit" />
                  </q-card-actions>
            </q-card>
        </q-dialog>

        <q-dialog v-model="waitNote" persistent content-class="non-transparent-dialog">
                <q-card class="centered-card">
                  <q-card-section>
                    <div class="spinner-container">
                      <q-spinner-facebook size="100px"></q-spinner-facebook>
        ...
        <q-dialog v-model="setHRNoteDialogs" persistent>
            <q-card class="HRNT">
                  ...
                  <q-separator style="background-color: #d5d7da; height: 2px; margin: 5px 0;"></q-separator>
                    <q-card-actions align="right">
                      <q-btn push label="CANCEL" color="secondary" @click="cancelHRConclusion" />
                      <q-btn push label="SAVE" color="accent" class="text-black" @click="ConHRSubmit" />
                    </q-card-actions>
            </q-card>
        </q-dialog>
        ...
        <q-td>
          <q-btn
            ...
            <q-card>
              ...
              <q-separator style="background-color: #d5d7da; height: 2px; margin: 5px 0;"></q-separator>
                <q-card-actions align="right">
                  <q-btn push label="NO" color="secondary" @click="setHRDialogs = false" />
                  <q-btn push label="YES" color="accent" class="text-black" @click="saveIRHRStatus" />
                </q-card-actions>
            </q-card>
            </q-dialog>
        </q-td>
...
export default {
  ...
  computed: {
    ...mapGetters({employees: 'ApplyStore/employees'}),
    filteredSpecificOff() {
      if (!this.DisciplineCode) {
        return this.disSpeOF;
      } else {
        return this.disSpeOF.filter(option => option.DisciplineCode === this.DisciplineCode);
      }
    },
  },
...
///////////////////////////////////////////////////////////sTATUS///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    try {
          ...
          console.log(payload)
          const response = await this.$store.dispatch("ApplyStore/puthrIR", payload);
          setTimeout(() => {
            this.getInc();
          }, 2000);
          this.$q.notify({
...
//////////////////////////////////////////////////////FINANCIAL LIABILITY////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  async saveResponse(choice) {
      try {
        ...
        console.log(payload)
        const response = await this.$store.dispatch("ApplyStore/AddfinLia", payload);
        setTimeout(() => {
        this.getInc();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    validateForm() {
      return this.IrNo && this.Emparties && this.SpecificOfNo && this.DisciplineCode && this.Occurrence && this.Penalties;
    },
